...
> *"Curious about the specific soil hazards and shrink-swell potential under your ZIP code? Use our local foundation calculator or access the service contact panel on this page to request a service quote from local contractors."*
> *(Note: Our calculator provides a first-step market estimate based on aggregated historical data. It is NOT engineering advice and does NOT constitute legal advice.)*
...
Unlike passive rebar, post-tensioning is an *active* reinforcement system. High-strength steel cables (tendons) are draped in a grid inside the wooden forms before the concrete is poured [7, 34, 35]. Once the concrete cures to a specific strength (typically around 2000 to 3000 PSI), technicians use hydraulic jacks to pull the cables to massive tensions—often up to 27,000 pounds of force (27 kips) [30, 34, 35]. The cables are then permanently anchored at the edges of the slab.
...
| Decade | Dominant Innovative Method | Geotechnical Response | Key Weakness / Risk Factor |
| :--- | :--- | :--- | :--- |
| **Pre-1950s** | Rubble Trenches / Pad Stones | Focused on drainage / load distribution | Highly vulnerable to expansive clay shifting |
| **1950s-1960s** | Conventional Slab-on-Grade | Passive rebar to hold concrete together | Tensile failure; rebar only works *after* cracking |
| **1970s-1980s** | Post-Tension Cables | Active compression to "float" over clay | Relies on cable integrity; complex to repair |
| **1990s-2000s** | Standardized PT Slabs | Better vapor/moisture barriers | Vulnerable if grading or landscaping is poor |
| **2010s-2020s** | Highly Engineered (PTI Codes) | Strict modeling of soil shrink/swell | Expensive; relies on flawless execution |
